...
exports.googleMapIsInstalled =
  exports.createNotSupportedComponent =
  exports.getNativeMapName =
  exports.ProviderContext =
  exports.NOT_SUPPORTED =
  exports.USES_DEFAULT_IMPLEMENTATION =
  exports.SUPPORTED =
    void 0;
...
exports.googleMapIsInstalled = !!react_native_1.UIManager.getViewManagerConfig(
  getNativeMapName(ProviderConstants_1.PROVIDER_GOOGLE),
);
function decorateMapComponent(Component, componentName, providers) {
  const components = {};
  const getDefaultComponent = () =>
    (0, react_native_1.requireNativeComponent)(
      getNativeComponentName(undefined, componentName),
    );
  ...
  Component.prototype.getNativeComponent = function getNativeComponent() {
    ...
    if (
      ...
      throw new Error(
        `react-native-maps doesn't support ${react_native_1.Platform.OS}`,
      );
    }
    ...
    if (platformSupport === exports.NOT_SUPPORTED) {
      components[key] = (0, exports.createNotSupportedComponent)(
        `react-native-maps: ${nativeComponentName} is not supported on ${react_native_1.Platform.OS}`,
      );
      ...
      if (
        ...
        components[key] = (0, react_native_1.requireNativeComponent)(
          nativeComponentName,
        );
      }
    } else {
  ...
  Component.prototype.getUIManagerCommand = function getUIManagerCommand(name) {
    ...
    return react_native_1.UIManager.getViewManagerConfig(nativeComponentName)
      .Commands[name];
  };
