...
export declare const MarkerAnimated: import('react-native').Animated.AnimatedComponent<
  typeof import('./MapMarker').MapMarker
>;
export declare const OverlayAnimated: import('react-native').Animated.AnimatedComponent<
  typeof import('./MapOverlay').MapOverlay
>;
